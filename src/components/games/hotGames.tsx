        ...
        {chunkedHotGames.map((chunk: any[], index: number) => (
          ...
          >
            {chunk.map((game, gameIndex) => (
              <div  key={gameIndex} className=''>

                <GameCard
                  ImageClass={' portrait:rounded-[1.5vh] landscape:rounded-[1.5vw] '}
                  StylesClass={'portrait:w-[6.5vh] portrait:h-[10vh]  landscape:w-[6.5vw] landscape:h-[10vw]   portrait:rounded-[1.6vh] landscape:rounded-[1.6vw]'}
                />
              </div>
            ))}
          </CarouselItem>
