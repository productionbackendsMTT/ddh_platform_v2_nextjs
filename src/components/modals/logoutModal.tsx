...
const LogoutModal = () => {
  return (
      <div className=" bg-[#60185E] p[ortrait:rounded-[1.5vh] landscape:rounded-[1.5vw] portrait:rounded-[1.5vh] portrait:border-[.3vh] landscape:border-[.3vw] border-[#B732B4] portrait:shadow-[1vh] landscape:shadow-[1vw] portrait:p-[2vh] landscape:p-[2vw] text-white w-full text-center ">
