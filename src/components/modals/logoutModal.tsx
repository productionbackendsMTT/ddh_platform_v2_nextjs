...
const LogoutModal = () => {
  return (
      <div className=" bg-[#60185E] z-50 p[ortrait:rounded-[1.5vh] landscape:rounded-[1.5vw] portrait:rounded-[1.5vh] portrait:border-[.3vh] landscape:border-[.3vw] border-[#B732B4] portrait:shadow-[1vh] landscape:shadow-[1vw] portrait:p-[2vh] landscape:p-[2vw] text-white w-full text-center ">
        ...
        <div className="flex justify-center portrait:space-x-[1vh] landscape:space-x-[1vw]">
          ...
          <Link
            href="/logout"
            className="bg-pink-400 hover:bg-yellow-500 text-purple-800 font-bold landscape:text-[1vw] portrait:text-[1vh] landscape:py-[.4vw] portrait:py-[.4vh] landscape:px-[1vw] portrait:px-[1vh] rounded-full  transition duration-300"
          >
            Logout
          </Link>
        </div>
