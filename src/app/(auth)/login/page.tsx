...
const page = () => {
  return (
    ...
    portrait:bg-[url('/assets/images/mobile-login-bg.png')] landscape:bg-[url('/assets/images/login-bg.png')]"
      >
        <Image src="/assets/header/logo.png" alt="login_logo" height={1000} width={1000} quality={100} priority className="absolute portrait:top-[8vh] landscape:top-0  left-[50%] translate-x-[-50%] portrait:w-[32vh] landscape:w-[26vw]" />
